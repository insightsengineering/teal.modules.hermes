...
```{r}
ui_surv_forest <- function(id, datasets, mae_name, pre_output, post_output) {
  ns <- NS(id)
  ...
  teal.devel::standard_layout(
    encoding = div(
      ...
      selectInput(ns("gene_id"), "Gene ID", choices = ""),
...
```{r}
srv_surv_forest <- function(input, output, session, datasets, mae_name) {
