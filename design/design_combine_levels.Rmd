...
srv_g_levels <- function(input,
  ...
  combModal <- function(facet_levels, 
    ...
    modalDialog(
      shinyRadioMatrix::radioMatrixInput(
        ...
        rowIDs = seq_along(facet_levels),
        rowLLabels = facet_levels,
        choiceNames = seq_len(n_max_groups),
        selected = selected_groups
      ),
      span(
        "Please enter click to group the original factor levels"
      ),
      footer = tagList(
        modalButton("Cancel"),
  ...
  observeEvent(input$open_levels_input, {
    ...
    facet_levels <- levels(colData(experiment_data)[[facet_var]])
