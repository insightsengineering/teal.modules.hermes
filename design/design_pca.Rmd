...
srv_g_pca <- function(input,
  ...
  # # update label_repel based on input$label
  # observeEvent(input$label == FALSE, {
  #   shinyWidgets::updateSwitchInput(
  #     session,
  #     inputId = input$label_repel,
  #     value = FALSE
  #   )
  # })
  # observeEvent(input$label == TRUE, {
  #   shinyWidgets::updateSwitchInput(
  #     session,
  #     inputId = input$label_repel,
  #     value = TRUE
  ...
  output$plot_pca <- renderPlot({
    ...
    req(
      ...
      #isTRUE(all(color_var) %in% names(SummarizedExperiment::colData(experiment_data))), ### WHY DOES THIS FAIL??? ###
      cancelOutput = FALSE
    )
